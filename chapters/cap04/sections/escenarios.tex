% Seccion: Escenarios de operación
\section{Escenarios de operación}
\label{sec:cap04_escenarios}

Este apartado expone detalladamente los aspectos fundamentales de escenarios de operación para el colector solar de aire.
