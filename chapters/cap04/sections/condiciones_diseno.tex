% Seccion: Condiciones de diseño
\section{Condiciones de diseño}
\label{sec:cap04_condiciones_diseno}

Este apartado expone detalladamente los aspectos fundamentales de condiciones de diseño para el colector solar de aire.
