% Seccion: Tipo y enfoque de investigación
\section{Tipo y enfoque de investigación}
\label{sec:cap04_tipo_enfoque}

Este apartado expone detalladamente los aspectos fundamentales de tipo y enfoque de investigación para el colector solar de aire.
