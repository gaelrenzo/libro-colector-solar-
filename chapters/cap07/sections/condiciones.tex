% Seccion: Condiciones de frontera
\section{Condiciones de frontera}
\label{sec:cap07_condiciones}

Este apartado expone detalladamente los aspectos fundamentales de condiciones de frontera para el colector solar de aire.
