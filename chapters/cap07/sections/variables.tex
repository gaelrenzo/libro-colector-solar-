% Seccion: Variables de análisis
\section{Variables de análisis}
\label{sec:cap07_variables}

Este apartado expone detalladamente los aspectos fundamentales de variables de análisis para el colector solar de aire.
