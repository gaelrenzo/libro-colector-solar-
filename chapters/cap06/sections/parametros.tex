% Seccion: Parámetros de salida esperados
\section{Parámetros de salida esperados}
\label{sec:cap06_parametros}

Este apartado expone detalladamente los aspectos fundamentales de parámetros de salida esperados para el colector solar de aire.
