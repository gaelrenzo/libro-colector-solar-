% Seccion: Resultados del análisis CFD
\section{Resultados del análisis CFD}
\label{sec:cap09_cfd}

Este apartado expone detalladamente los aspectos fundamentales de resultados del análisis cfd para el colector solar de aire.
