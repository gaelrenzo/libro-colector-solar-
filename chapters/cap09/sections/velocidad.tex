% Seccion: Distribución de velocidad del aire
\section{Distribución de velocidad del aire}
\label{sec:cap09_velocidad}

Este apartado expone detalladamente los aspectos fundamentales de distribución de velocidad del aire para el colector solar de aire.
