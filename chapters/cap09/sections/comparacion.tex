% Seccion: Comparación de resultados entre software
\section{Comparación de resultados entre software}
\label{sec:cap09_comparacion}

Este apartado expone detalladamente los aspectos fundamentales de comparación de resultados entre software para el colector solar de aire.
