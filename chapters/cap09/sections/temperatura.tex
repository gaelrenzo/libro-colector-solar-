% Seccion: Distribución de temperatura
\section{Distribución de temperatura}
\label{sec:cap09_temperatura}

Este apartado expone detalladamente los aspectos fundamentales de distribución de temperatura para el colector solar de aire.
