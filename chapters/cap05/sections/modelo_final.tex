% Seccion: Modelo final del colector
\section{Modelo final del colector}
\label{sec:cap05_modelo_final}

Este apartado expone detalladamente los aspectos fundamentales de modelo final del colector para el colector solar de aire.
