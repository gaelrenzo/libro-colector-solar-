% Seccion: Selección de dimensiones geométricas
\section{Selección de dimensiones geométricas}
\label{sec:cap05_dimensiones}

Este apartado expone detalladamente los aspectos fundamentales de selección de dimensiones geométricas para el colector solar de aire.
