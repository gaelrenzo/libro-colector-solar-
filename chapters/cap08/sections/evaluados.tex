% Seccion: Software evaluados
\section{Software evaluados}
\label{sec:cap08_evaluados}

Este apartado expone detalladamente los aspectos fundamentales de software evaluados para el colector solar de aire.
