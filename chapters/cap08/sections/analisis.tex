% Seccion: Comparación para análisis CFD
\section{Comparación para análisis CFD}
\label{sec:cap08_analisis}

Este apartado expone detalladamente los aspectos fundamentales de comparación para análisis cfd para el colector solar de aire.
